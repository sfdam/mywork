({
    ...
    validateSelectionDebitore : function(component, event) {
        ...
        if (jlaDeb !== undefined) {
            ...
            var mccProsMat = (servizio.Label === 'Factoring MCC' || servizio.Label === 'Anticipo Crediti Futuri MCC') && (debitore.prosoluto || debitore.mercato !== '001');                    
        ...
        else if ((servizio.Label === 'Factoring MCC' || servizio.Label === 'Anticipo Crediti Futuri MCC') && (debitore.prosoluto || debitore.mercato !== '001')) {
             this.showToast(component, "Errore", "Non puoi associare un prodotto garantito MCC ad un debitore con prosoluto o maturity o estero", "error");
             return false;
        } 
        return true;
