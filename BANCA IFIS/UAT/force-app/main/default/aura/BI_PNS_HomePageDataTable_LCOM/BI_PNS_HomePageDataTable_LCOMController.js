({
    ...
    handleChangeHorizon: function (component, event, helper) {
        ...
        var valoreFiltroRicerca = component.get('v.valoreFiltroRicerca');
		var valoreFiltroRicercaOrizzonte = component.get('v.valoreFiltroRicercaOrizzonte');

        if (valoreFiltroRicerca.length <= 2){

			helper.fetchWorkflowsMCCForHomePage(component,event, '', valoreFiltroRicercaOrizzonte);
            
        }
        
        if (valoreFiltroRicerca.length > 2){

			helper.fetchWorkflowsMCCForHomePage(component,event, valoreFiltroRicerca, valoreFiltroRicercaOrizzonte);
