...
export default class Wgc_lookup extends LightningElement {
    @api label;
    @api selection = [];
    @api placeholder = '';
    ...
    renderedCallback(){
        if(this.selection.length > 0 && ( this.selection[0].id == '' || this.selection[0].id == null || this.selection[0].id == undefined) && this.selection[0].sObjectType != "")
            this.selection = [];
    }
    ...
    @api
    getSelection() {
        console.log('@@@ get selection ' , this.selection);
    ...
    handleResultClick(event) {
        ...
        this.dispatchEvent(new CustomEvent('selectionchange', { detail: { value : this.selection } }));
    }
    ...
    get getInputValue() {
        ...
        return this.hasSelection() ? this.selection[0].id != '' ? this.selection[0].title : null : this.searchTerm;
    }
    ...
    get isInputReadonly() {
        ...
        return this.hasSelection() || this.readOnly;
    }
