({
    ...
    handleNavigate: function(component, event , helper) {
        ...
        if(!component.find("flowInputAnagraficaViaSpedizioneInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaViaSpedizioneInputId").reportValidity();
            
        }  

        if(!component.find("flowInputAnagraficaCivicoSpedizioneInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaCivicoSpedizioneInputId").reportValidity();
            
        }  

        if(!component.find("flowInputAnagraficaCittaSpedizioneInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaCittaSpedizioneInputId").reportValidity();
            
        }  

        if(!component.find("flowInputAnagraficaCapSpedizioneInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaCapSpedizioneInputId").reportValidity();
            
        }  

        if(!component.find("flowInputAnagraficaProvinciaSpedizioneInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaProvinciaSpedizioneInputId").reportValidity();
            
        }  
        
        // VERIFICA DELLA SEZIONE ALTRI DATI
                
        if(!component.find("flowInputAnagraficaTelefonoInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaTelefonoInputId").reportValidity();
            
        }        
        
        if(!component.find("flowInputAnagraficaFaxInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaFaxInputId").reportValidity();
            
        }            
        
        if(!component.find("flowInputAnagraficaEmailInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaEmailInputId").reportValidity();
            
        } 
        
        if(!component.find("flowInputAnagraficaEmailPecInputId").get("v.validity").valid){
            
            overallValidity = false;
            
            component.find("flowInputAnagraficaEmailPecInputId").reportValidity();
