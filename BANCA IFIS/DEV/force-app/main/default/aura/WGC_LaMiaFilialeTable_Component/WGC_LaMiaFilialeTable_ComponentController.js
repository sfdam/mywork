({
	init : function(component, event, helper) {
		component.set('v.columns',[{label:'', fieldName: "descrizione", type:"String", initialWidth: 300 },
									{label:'YTD', fieldName: "ytd", type:"String", cellAttributes: { alignment: 'right'}, class:{ fieldName:"descrizione"}},
									{label:'OBJ', fieldName: "obj", type:"String",cellAttributes: { alignment: 'right' }},
									{label:'A%', fieldName: "percA1", type:"String", initialWidth: 60},
									{label:'Y-1', fieldName: "y1", type:"String", cellAttributes: { alignment: 'right' }},
									{label:'A%', fieldName: "percA2", type:"String", initialWidth: 60}]);

		var descriptions = ['Margine Interesse','MDI GESTIONALE','Rettifiche nette e rischio di credito',' ','RISULTATO GESTIONE FINANZIARIA','Spese Amministrative Personale','Spese Amministrative Diverse','Rettifiche di valore su attività IMM./MAT.',' ','TOTALE COSTI OPERATIVI', 'UTILE LORDO ANTEIMPOSTE'];
		var arr =[];
		for(var i=0;i<descriptions.length;i++){
			var a;
			if(descriptions[i]==' '){
				a ={ descrizione: descriptions[i],
					ytd: '',
					obj: '',
					percA1: '',
					y1:'',
