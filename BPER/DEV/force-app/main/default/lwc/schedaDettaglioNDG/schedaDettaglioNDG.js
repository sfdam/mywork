...
export default class schedaDettaglioNDG extends NavigationMixin(LightningElement) {
    ...
    getUserInfo()
        .then(result => {
            ...
            if(result.Profile.Name=='System Administrator'||result.Profile.Name=='NEC_D.0'||result.Profile.Name=='NEC_T.7'||result.Profile.Name=='NEC_T.8'||
                result.Profile.Name=='NEC_D.5' || result.Profile.Name=='NEC_D.4' ||result.Profile.Name=='NEC_F.1'|| (result.Profile.Name=='NEC_D.2' && result.idced__c=='4439')){
                this.isVisible=true;
                console.log("MC IsVisible",this.isVisible);
                }
        ...
        .then(result => {
            ...
            result.forEach(element => {
                ...
                if(element.PTF_StatoCRM__c){
                    ...
                    if(this.statoCRM=='ATT')
                        this.statoCRM='Attivo';
                    else if(this.statoCRM=='NATT')
                        this.statoCRM='Non attivo';
                    else if(this.statoCRM=='NEG')
                        this.statoCRM='Negativo';
                    else if(this.statoCRM=='SOFF')
                        this.statoCRM='Sofferenza';
                    else if(this.statoCRM=='EST')
                        this.statoCRM='Estinto';
                    else if(this.statoCRM=='SVIL')
                        this.statoCRM='Sviluppo';
                    else this.statoCRM='';
                }        
