...
export default class DoppioPresidioEstero  extends NavigationMixin (LightningElement) {
    ...
    handleSearch(event){
        ...
        this.referentiList=this.data;
        this.page = 1;
        console.log('Ricerca: ' + this.searchedNominativo);
        console.log('Ricerca: ' + this.referentiList);
        
        try {
            for(var i in this.referentiList){   
                console.log('Ricerca i: ' + this.referentiList[i].Name);
