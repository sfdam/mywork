...
import { OMNIDEF } from './docGenerationSampleFndMultiDocxLwcEnglish_def.js';
import tmpl from './docGenerationSampleFndMultiDocxLwcEnglish.html';
import tmpl_nds from './docGenerationSampleFndMultiDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleFndMultiDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
