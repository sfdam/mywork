...
const columns = [
    ...
    { label: 'Bisogno', fieldName: 'CRM_Bisogno__c', type: 'text', hideDefaultActions: true, sortable: true },
    ...
    { label: 'Autore', fieldName: 'CRM_Autore__c', type: 'text', hideDefaultActions: true, sortable: true },
