({
	doInit : function(component, event, helper) {
        ...
        console.log('TEST start recordId is: '+component.get("v.recordId"));
        ...
        if(recordId != null){
            ...
            flow.startFlow("CIB_Create_New_Opportunity");
        }
    ...
    handleStatusChange : function (component, event) {
        var flowOutput = event.getParam("outputVariables");
        var recordId = flowOutput.recordId;
        console.log('DEBUG***** recordId is: '+recordId);

        var recordIdFromFlow = event.getParam("outputVariables").recordId;
        console.log('DEBUG***** recordIdFromFlow is: '+recordIdFromFlow);
