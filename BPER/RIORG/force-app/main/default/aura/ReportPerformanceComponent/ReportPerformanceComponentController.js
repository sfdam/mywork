    ...
    doInit: function(component, event, helper) {
        ...
        getUrl.setCallback(this, function(response) {
            ...
            if (state === 'SUCCESS') {
                ...
                var ptfSL =
                    initialURL + 
                    "/apex/ReportPerformance?reportName=Monitoraggio_Portafogli_in_pool_degli_SL_5UN" //Qui ci va il report grafico VP 21/07/2022 New_PTF_0078_v04_Djn
                var utilizzatoNDG = 
                    initialURL + 
                ...
                crossReports.push(ndgMdsPtf+", " + distribNdgRoleMDS + ", "+ ptfSL + ", "+utilizzatoNDG + ", " + redditoFatturatoNDG + ", " +distribNDG_NEW+ ", " + accordatoNDG + ",  " +patrimonioNDG + ", " +redditoFatturatoNDG + ", " + ptf0078) 
                ...
                encodedUrl = encodeURI(ptfSL)
                component.set("v.ptfSL", ptfSL)
