...
import getNDG from '@salesforce/apex/NucleiAppartenenzaController.getNDG';
import getNDGAppartenenza from '@salesforce/apex/NucleiAppartenenzaController.getNDGAppartenenza';
import loadNdgList from '@salesforce/apex/NucleiAppartenenzaController.loadNdgList';
...
const columns = [
    ...
    { label: Nominativo, fieldName: 'Name', type: 'text', hideDefaultActions: "true", cellAttributes:{class:{fieldName: 'typeCSSClass' }}},
    ...
    { label: GruppoGestionale, fieldName: 'PTF_GruppoComportamentale__c', type: 'text', hideDefaultActions: "true"}
];

export default class NucleiAppartenenza extends LightningElement {
    @api userInfo;
    ...
    columnsAggiungi = [
        ...
        { label: ModelloServizio, fieldName: 'ModelloDiServizio__c', type: 'text' },
        { label: MicroPortafoglio, fieldName: 'PTF_MPUrl', type: 'url', typeAttributes: {label: { fieldName: 'PTF_PortafoglioName' }}},
    ...
    handleAssignToNucleo(){
        ...
        if(selectedRows.length > 0){
            ...
            console.log('MC nucleoId: ' + newThis.currentAccount.PTF_Nucleo__c);
            assignToNucleo({
