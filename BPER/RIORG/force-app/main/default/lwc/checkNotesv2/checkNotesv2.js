...
import getRecordNotes from '@salesforce/apex/CheckupListViewControllerv2.getRecordNotes';
    ...
    connectedCallback(){
        ...
        console.log('fieldsToShow ', this.fieldsToShow);
         ...
         listColumn.forEach(element => {
             ...
             console.log('obj.label: '+obj.label+' obj.fieldName: '+obj.fieldName+' type: obj.type: '+ obj.type+' fixedWidth: obj.fixedWidth: '+obj.fixedWidth+' wrapText obj.wrapText: '+obj.wrapText);
         ...
         var listElementTemp = [];
         getRecordNotes({recordId: this.recordId, numberOfRecords: this.numberOfRecords, filter: this.filterField /*, noteField: firstElement.fieldName*/})
         .then(result => {
