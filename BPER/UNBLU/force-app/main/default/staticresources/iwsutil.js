class Util {
    ...
    async unbluPersonSearch(){
        ...
        try{
            var id = await sfutil.callApiSync(UnbluController.unbluPersonSearch,window["gcUser"].username);
    ...
    async updateUnbluChatAccepted(caseId){
        try{
            var result = await sfutil.callApiSync(UnbluController.updateUnbluChatAccepted,caseId);
