                ...
                //Recupero root xml
                    ...
                    if(result){                   
                        ...
                        if(this.fullMetadata && this.fullMetadata.length > 0){
                            ...
                            for(var i = 0; i < this.fullMetadata.length; i++){
                                ...
                                if(m.SECTION__c && m.COMPONENT__c && m.isActive__c && !m.isRoot__c){
                                    if(m.HasQuery__c){
                                        ...
                                        promiseArrayAsynch[i] = {method: 'getXMLFromQuery4PromiseData', meta: m};
                                        ...
                                        promiseArrayAsynch[i] = {method: 'getXMLFromMethods4PromiseData', meta: m};
                            ...
                            .then(()=>{
                                this.showToastMessage('STIAMO CREANDO IL PDF. RICEVERAI UNA NOTIFICA APPENA L\'OPERAZIONE SARA\' CONCLUSA', 'success');
                                this.showSpinner = false;
                                this.closeModal();
                            })
                            .catch(err =>{
