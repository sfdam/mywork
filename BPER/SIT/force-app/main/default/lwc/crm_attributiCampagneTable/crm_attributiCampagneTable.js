        ...
        try {
            ...
            .then(result => {
                ...
                result.campaignMemberList.forEach(element =>{
                    ...
                    element.CRM_Assegnatario = element.CRM_AssegnatarioUser__r ? element.CRM_AssegnatarioUser__r.Name : '';
                    ...
                    element.CRM_Data_Inserimento = element.CreatedDate;
                ...
                this.columns = [
                    ...
                    { label: 'M-MDS', fieldName: 'PTF_ModelloDiServizio__c', type: 'text', sortable: "true",hideDefaultActions: true,},
                    ...
                    { label: 'Data Ingresso', fieldName: 'CRM_Data_Inserimento', type: 'date', sortable: "true"},
