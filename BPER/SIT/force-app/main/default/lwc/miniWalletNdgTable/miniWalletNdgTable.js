...
import getNDG from '@salesforce/apex/MiniWalletNdgTableController.getNDG';
import updateNDG from '@salesforce/apex/MiniWalletNdgTableController.updateNDG';
...
const COLS = [
    ...
    /*{ label: 'Nome', fieldName: 'FirstName', hideDefaultActions: true },
    { label: 'Cognome', fieldName: 'LastName', hideDefaultActions: true },*/
...
export default class MiniWalletNdgTable extends LightningElement {

    columns = COLS;
    @api recordId;
    @api title = 'Aggiungi NDG';
    @api openmodel = false;
    @track searchedNome = '';
    @track searchedNDG = '';
    @track tableRows = [];
    ...
    handleSave(){
        ...
        updateNDG({ miniWalletId: this.recordId, ndgIdList: this.selectedNdgIdRows })
                .then(result => {
                    if(result){
                        const toastEvent = new ShowToastEvent({
                            message: "NDG inseriti correttamente",
                            variant: "success"
                        });
    ...
    handleSearch(){
        ...
        try {
            ...
            /*if(this.searchedNome!=='' || this.searchedNDG!=='')
            {
                this.selectedNDGRows=this.filteredRecords;
            }*/
            this.setPages(this.filteredRecords);
