...
export default class AssegnaAzioniTab extends NavigationMixin(LightningElement) {
        ...
        try {
            ...
            for(let keyC in campaign){
                ...
                if(selectedRowsArray.includes(keyArray[0])){
                    ...
                    //console.log('campaign[keyC].PTF_Miniportafoglio: '+campaign[keyC].PTF_Miniportafoglio);
                    if(!set){
    ...
    handleAssegnaEVTabRequest(event){
        ...
        // this.selectedNomeAttributo1EVTab = this.selectedEVTabRow[0].Campaign__r.CRM_NomeAttributo1__c;
        // this.selectedNomeAttributo2EVTab = this.selectedEVTabRow[0].Campaign__r.CRM_NomeAttributo2__c;
    ...
    onHandleSort( event, refTabVar, tableName) {
        try {
            ...
            console.log('DK onHandleSort.tab: ' ,tab);
            ...
            console.log('DK onHandleSort.listName: ' , listName);
            console.log('DK onHandleSort.filteredList: ' , filteredList);
