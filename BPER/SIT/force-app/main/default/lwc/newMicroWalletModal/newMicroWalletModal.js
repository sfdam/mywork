...
export default class NewMicroWalletModal extends NavigationMixin(LightningElement) {
    ...
    @track valueCheckbox = false;
    @track valueCheckbox2 = false; // LV CR NEC #70081
    ...
    nextStep() {
        ...
        if(allValid){
            ...
            if(this.valueCheckbox === true /*&& (this.valueModServizio !== 'POE') && (this.valueModServizio !== 'Family') && (this.valueModServizio !== 'Controparti Istituzionali')*/ ) {
                    ...
                    if(result){
                        ...
                        if(this.valueModServizio === 'Private'){
                            ...
                            /*getGestoriPrincipali({ filialeId: valueFiliale, modelloServizio: valueModServizio, isChecked999: this.valueCheckbox, 
                                ischeckedPTF: this.valueCheckbox2 }) // LV CR NEC #70081
                            .then(result => {
    ...
    getRefsPrivate(valueFiliale, valueModServizio, allValid){
        getGestoriPrincipaliPrivate({idFiliale: valueFiliale, modelloServizio: valueModServizio, ufficioPrivate: this.selectedOption, abi: this.abi, isCheckedPTF: this.valueCheckbox, isPTFSvil: this.valueCheckbox2})
        .then(result => {
            this.getAllGestoriPrincipali = result;
    ...
    handleSave(){
        ...
        if(allValid){
            if(!gestorePrincipale.some(item => gestoreBackup.includes(item))){
                ...
                isCheckbox2Checked : this.valueCheckbox2}) // LV CR NEC #70081
                    .then(result => {
   ...
   /* handleCheckboxNumMicroPortafoglio(event){
    ...
    changeToggle(event) {
        ...
        if( this.valueCheckbox === true){
            this.disabledNumMicroPortafoglio = true;
            this.valueNumMicroPortafoglio = '1';
            this.valueCheckbox2 = false; // LV CR NEC #70081          
        }else{
            this.disabledNumMicroPortafoglio = false;
        }
    ...
    changeToggle2(event) {
        ...
        this.valueCheckbox2 = event.target.checked;

        if( this.valueCheckbox2 === true){
            this.valueCheckbox = false;         
            this.disabledNumMicroPortafoglio = false;  
        }
