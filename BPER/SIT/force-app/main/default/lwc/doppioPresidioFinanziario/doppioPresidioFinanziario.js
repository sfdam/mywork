...
export default class DoppioPresidioFinanziario extends NavigationMixin(LightningElement) {
    ...
    loadNDGRecords(){
        ...
        .then(result => {
            ...
            for (var i=0; i<this.retValue.consulentiFinanziari.length; i++) {
                if (this.retValue.consulentiFinanziari[i].PTF_TipologiaRuolo__r!=undefined && this.retValue.consulentiFinanziari[i].PTF_TipologiaRuolo__r.Name!=undefined) {
    ...
    getSelectedRows(event){
        ...
        console.log('@@@164', this.selectedRows);
    }
    ...
    handleIndietro(){
      ...
      get disabledButtonAvanti(){
          console.log('@@@@@disabledbuttonsonoqui');
