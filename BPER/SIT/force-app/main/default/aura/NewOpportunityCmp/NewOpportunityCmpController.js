({
    ...
    handleClick : function(component, event, helper){
        ...
        if(!getOptionSelected){
            ...
            if(getOptionSelected != 'Corporate Finance' && getOptionSelected != 'Structured Finance' && getOptionSelected != 'Traditional Banking'){
            ...
            }else if((getOptionSelected == 'Corporate Finance' || getOptionSelected == 'Structured Finance' || getOptionSelected == 'Traditional Banking')){
                component.set('v.showChoise',false);
