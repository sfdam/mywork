...
import { OMNIDEF } from './infoPrivilegiateFndSingleDocxLwcEnglish_def.js';
import tmpl from './infoPrivilegiateFndSingleDocxLwcEnglish.html';
import tmpl_nds from './infoPrivilegiateFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class infoPrivilegiateFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
