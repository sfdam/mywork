({
    ...
    onStartButtonClick: function(cmp) {
        ...
        if (isValid) {
            ...
            //var fields = [firstName, lastName, nomeRagioneS, email, cfPIva, dataNascita];
        ...
        try{
            ...
            prechatFields.forEach(function(field) {
                if (field.name !== 'CRM_MotivoDellaChat__c') {
                    ...
                    if(field.name == 'CRM_Bibanca__c') cmp.set("v.hostingSite",field.value);
