...
import { OMNIDEF } from './cibSegretariaODGFndSingleDocxLwcEnglish_def.js';
import tmpl from './cibSegretariaODGFndSingleDocxLwcEnglish.html';
import tmpl_nds from './cibSegretariaODGFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cibSegretariaODGFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
