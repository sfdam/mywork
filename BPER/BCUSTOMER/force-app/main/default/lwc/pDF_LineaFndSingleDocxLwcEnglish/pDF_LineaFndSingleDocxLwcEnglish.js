...
import { OMNIDEF } from './pDF_LineaFndSingleDocxLwcEnglish_def.js';
import tmpl from './pDF_LineaFndSingleDocxLwcEnglish.html';
import tmpl_nds from './pDF_LineaFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pDF_LineaFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
