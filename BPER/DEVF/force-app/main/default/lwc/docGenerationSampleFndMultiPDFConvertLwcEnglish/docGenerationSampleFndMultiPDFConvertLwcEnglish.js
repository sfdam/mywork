...
import { OMNIDEF } from './docGenerationSampleFndMultiPDFConvertLwcEnglish_def.js';
import tmpl from './docGenerationSampleFndMultiPDFConvertLwcEnglish.html';
import tmpl_nds from './docGenerationSampleFndMultiPDFConvertLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleFndMultiPDFConvertLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
