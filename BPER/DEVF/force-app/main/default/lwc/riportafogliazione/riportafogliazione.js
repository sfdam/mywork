...
const disclaimer="IN CASO DI CAMBIO MICROPORTAFOGLIO DI DESTINAZIONE, SI RICORDA DI SELEZIONARNE UNO COERENTE CON MODELLO DI SERVIZIO, PENA IL MANCATO RECEPIMENTO DELLA MODIFICA";
const COLUMNS = [
    {
        label: 'NDG',
        initialWidth: 100,
