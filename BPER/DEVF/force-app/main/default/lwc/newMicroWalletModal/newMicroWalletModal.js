...
export default class NewMicroWalletModal extends NavigationMixin(LightningElement) {
    ...
    @api valueDReg;
    @api valueAree;
    @api valueModulo; // LV 27-03-2024 CR NEC #79388
    @api valueCapofila;
    @api valueFiliale;
    ...
    @api labelDReg;
    @api labelAree;
    @api labelModulo; // LV 27-03-2024 CR NEC #79388
    @api labelCapofila;
    @api labelFiliale;
        ...
        if (messageResult != null) {
            ...
            if(source == 'newMicroWalletModalFooter'){
                if(message.action == 'nextStep'){
                    ...
                    if(this.valueModServizio == 'Private' && this.selectedOption == undefined && (!this.ptfCentriPrivate || (this.ptfCentriPrivate && this.selectedOption == undefined && this.selectedCentroOption != undefined))){
                        const toastEvent = new ShowToastEvent({
                            title: "Warning!",
                            message: "Selezionare un ufficio",
                            variant: "warning"
                        ...
                        this.dispatchEvent(toastEvent);
                    }else if(this.valueModServizio == 'Private' && this.selectedOption == undefined && this.ptfCentriPrivate && this.selectedCentroOption == undefined){
                        const toastEvent = new ShowToastEvent({
                            title: "Warning!",
                            message: "Selezionare un ufficio e un centro",
                            variant: "warning"
                        });
                        this.dispatchEvent(toastEvent);
                    }else if(this.valueModServizio == 'Private' && this.selectedOption != undefined && this.ptfCentriPrivate && this.selectedCentroOption == undefined){
    ...
    getRefsPrivate(valueFiliale, valueModServizio, allValid){
        ...
        getGestoriPrincipaliPrivate({idFiliale: valueFiliale, modelloServizio: valueModServizio, ufficioPrivate: this.selectedOption, abi: this.abi, isCheckedPTF: this.isPTF999, isPTFSvil: this.isPTFSvil, centroPrivate: this.selectedCentroOption})
        .then(result => {
            this.getAllGestoriPrincipali = result;
            ...
            console.log('ref princ: '+this.listViewDataGestorePrincipale);
            //SV aggiunto centro private in input
            return getGestoriBackupPrivate({idFiliale: this.valueFiliale, modelloServizio: this.valueModServizio, ufficioPrivate: this.selectedOption, abi: this.abi, centroPrivate: this.selectedCentroOption})
        })
        .then(result => {
            this.getAllGestoriBackup = result;
            let rowsGestoriBackupPrivate = [];
    ...
    handleChangeFiliale(idFiliale){
        ...
        // LV 27-03-2024 CR NEC #79388 start
        this.valueModulo = filiale.PTF_BranchTypeDesc__c;
        this.labelModulo = filiale.PTF_BranchTypeDesc__c;
        // LV 27-03-2024 CR NEC #79388 end
    ...
    handleSave(){
        ...
        if(allValid){
            if(!gestorePrincipale.some(item => gestoreBackup.includes(item))){
                ...
                isPTFSvil : this.isPTFSvil, centroPrivate: this.selectedCentroOption}) // LV CR NEC #70081
                    .then(result => {
    ...
    refreshFiltri(){
        ...
        this.valueDReg='';
        this.valueAree='';
        this.valueModulo=''; // LV 27-03-2024 CR NEC #79388
        this.valueFiliale='';
        ...
        this.optionsDReg = [];
        this.optionsAree = []; 
        this.optionsModulo = []; // LV 27-03-2024 CR NEC #79388
