...
export const EXAMPLES_COLUMNS_DEFINITION_BASIC = [
    ...
    /*{
        type: 'text',
        fieldName: 'PTF_TipoCollegamento__c',
        label: 'TIPO',
        initialWidth: 120,
    },*/ //valerio.salvati 04/10/2020
    /*{
        type: 'text',
        fieldName: 'PTF_DescTipoCollegamento__c',
        label: 'DESCRIZIONE',
    },*/
    {
        type: 'text',
...
import getAllData from '@salesforce/apex/treeGridGruppiController.crm_getAllData';
...
export default class Crm_treeGridGruppi extends NavigationMixin(LightningElement) {
    @track loaded = false;
    @track error;
    @api recordId;
    @api account;
                            ...
                            allData['gruppiMap'][keyG]._children = [];
                                ...
                                for(let keyA in allData['accMap']){
                                    if(allData['accToLinkObj'][keyA]){
                                        ...
                                        allData['accMap'][keyA].CRM_LinkType__c = allData['accToLinkObj'][keyA].CRM_LinkType__c;
                    ...
                    if(allData.hasOwnProperty('accMap')){
                        for(let key in allData['accMap']){
                            ...
                            if(allData['accToLinkObj'][key]){
                                ...
                                allData['accMap'][key].CRM_LinkType__c = allData['accToLinkObj'][key].CRM_LinkType__c;
    ...
    get dataLoadedViewAll(){
        return this.gridDataAll.length > this.numRows;
    }
