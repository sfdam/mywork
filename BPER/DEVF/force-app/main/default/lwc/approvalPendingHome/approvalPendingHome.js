...
const columns = [
    ...
    { label: Portafoglio_destinazione, fieldName: 'PTF_UrlPTFDestinazione', type: 'url',
        ...
        hideDefaultActions: "true"},
    { label: 'MDS', fieldName: 'DestinazioneMMDS', type: 'text'},
...
const modalColumns = [
    ...
    { label: Filiale_destinazione, fieldName: 'PTF_UrlFilialeDestinazione', type: 'url',
        ...
        hideDefaultActions: "true"},
    // M-MDS DI PARTENZA
    { label: 'MDS Partenza', fieldName: 'OrigineMMDS', type: 'text'},
    // M-MDS DI DESTINAZIONE
    { label: 'MDS Destinazione', fieldName: 'DestinazioneMMDS', type: 'text'},
