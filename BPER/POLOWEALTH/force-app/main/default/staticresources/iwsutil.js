class Util {
    ...
    async unbluPersonSearch(){
        ...
        try{
            ...
            */
            if ( !userId ){
                scheduleUtils.showDialog("Attenzione", "Non Ã¨ stato possibile recuperare unblu person id.Si prega di contattare un amministratore.",false)
                return;
            }
            ...
            scheduleUtils.showDialog("Attenzione", "Non Ã¨ stato possibile recuperare unblu person id.Si prega di contattare un amministratore.")
            return;
        }
    }
    ...
    async unbluAddParticipant(unbluConvId){
        ...
        try{
            ...
            scheduleUtils.showDialog("Attenzione", "Non Ã¨ stato possibile aggiungerti alla conversazione.Si prega di contattare un amministratore.")
    ...
    async unbluSetAssigneePerson(unbluConvId){
        ...
        try{
            ...
            scheduleUtils.showDialog("Attenzione", "Non Ã¨ stato possibile assegnarti alla conversazione.Si prega di contattare un amministratore.")
    ...
    async unbluRequeueConversation(unbluConvId){
     ...
     getGenesysAgentId() {
        ...
        try{
            ...
            scheduleUtils.showDialog("Attenzione", "Non ï¿½ stato possibile connecttersi a Genesys.Si prega di refreshare il browser.")
            return;
        }
    ...
    async updateCaseRoutingStatus(caseId,status){
        ...
        try{
            ...
            scheduleUtils.showDialog("Attenzione", "Non ï¿½ stato possibile aggiornare il flag CRM_OnQueue per il caseId : " + caseId + ". Contattare l'amministrazione.")
