            ...
            try{
                ...
                .then(result => {
                    ...
                    try {
                        ...
                        if(this.currentUser.Profilo__c !== 'NEC_D.0'){
                            newValueList = newValueList.filter(element =>{return element.Id != portafoglioPrimarioId || (element.Id == portafoglioPrimarioId && filialeSet.includes(element.PTF_Filiale__c) && modelloDiServizioSet.includes(element.PTF_ModelloDiServizio__c))})
                        }
                        this.mwList = this.mwList.concat(newValueList);
                        this.mwListCount = this.mwList.length;
