    ...
    handleAssignNDGs() {
        ...
        try {
            ...
            if(mwSelected.length > 0){
                ...
                if(this.ruolo == 'primario' && mwSelected[0].PTF_ModelloDiServizio__c != 'Consulenti Finanziari' && mwSelected[0].PTF_ModelloDiServizio__c != 'Cesare Ponti'){
                ...
                if(this.superUser){
                    ...
                    var params = {
                        ...
                        ruolo: this.ruolo,
                        moveAll: mwSelected[0].PTF_ModelloDiServizio__c != 'Consulenti Finanziari' && mwSelected[0].PTF_ModelloDiServizio__c != 'Cesare Ponti',
