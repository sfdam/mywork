...
export default class SpostaNdgIter extends NavigationMixin(LightningElement) {
    ...
    get optionsModServizio(){
        ...
        modServizio.forEach(element => {
            ...
            if(this.superUser){
                ...
                //     if(element != 'POE'){
                //         console.log('pz 575',element);
                //         objList.push(obj);
                //         console.log('pz 575 objList',objList);
                //     }
                // }
                objList.push(obj);
                ...
                objList.push(obj);
                console.log('pz 594 objList',objList);
            }
        });
        console.log('pz objList',JSON.stringify(objList));
        return objList;
    ...
    checkEligible(ndg, portafoglioDiPartenza, portafoglioDiDestinazione, isPTFInEvidenza, allInSame, getKey){
        ...
        console.log('pz sono qua222');
        console.log('pz sono qua222',ndg);
        let iterKeyListMap = {};
    ...
    getAllData(){
        ...
        try{
            ...
            .then(result => {
                ...
                //pz 05.03.2024 add idFittiziaMap
                this.idFittiziaMap = result["idFittiziaMap"];
                console.log(' this.idFittiziaMap',JSON.stringify(this.idFittiziaMap)); 
        ...
        try{
            ...
            if(this.selectedMWRows.length > 0){
                ...
                .then(result => {
                    ...
                    this.ndgList = result["ndgList"].filter(ndg => {console.log('pz this.ndgList ');
                        return ndg.RecordType.DeveloperName === 'GruppoFinanziario' || this.checkEligible(ndg, result['portafoglioMap'][ndg.PTF_Portafoglio__c], this.selectedMWRows[0], true, this.allInSame, false) != null;});
