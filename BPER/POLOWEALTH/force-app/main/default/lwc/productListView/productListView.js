    ...
    connectedCallback() {
        ...
        getUserInfo()
            ...
            .then(result => {
                ...
                return getAllData({ objRecordType: recordTypeProduct.split(','), statusFinServ: this.statusFinServ, recordId: recordId, fields: JSON.stringify(fieldsObj), userProfile: this.userInfo.Profile.Name, rapportoFinServ: this.rapportoFinServ })
