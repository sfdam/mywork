    ...
    connectedCallback() {
        ...
        getAvailabilityMonths({
            ...
            .then(result => {
                ...
                console.log(' pz this.thead1', JSON.stringify(this.thead1));
                console.log(' pz this.tbody1', JSON.stringify(this.tbody1));
                console.log(' pz this.thead2', JSON.stringify(this.thead2));
                console.log(' pz this.tbody2', JSON.stringify(this.tbody2));
