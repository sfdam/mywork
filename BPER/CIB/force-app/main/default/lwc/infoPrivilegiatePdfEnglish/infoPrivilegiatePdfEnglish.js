...
import { OMNIDEF } from './infoPrivilegiatePdfEnglish_def.js';
import tmpl from './infoPrivilegiatePdfEnglish.html';
import tmpl_nds from './infoPrivilegiatePdfEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class infoPrivilegiatePdfEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
