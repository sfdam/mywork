...
import { OMNIDEF } from './pDF_SegretariaCibODG1FndSingleDocxLwcEnglish_def.js';
import tmpl from './pDF_SegretariaCibODG1FndSingleDocxLwcEnglish.html';
import tmpl_nds from './pDF_SegretariaCibODG1FndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pDF_SegretariaCibODG1FndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
