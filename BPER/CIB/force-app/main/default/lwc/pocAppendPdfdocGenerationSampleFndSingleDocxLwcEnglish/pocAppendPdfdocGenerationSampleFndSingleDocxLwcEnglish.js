...
import { OMNIDEF } from './pocAppendPdfdocGenerationSampleFndSingleDocxLwcEnglish_def.js';
import tmpl from './pocAppendPdfdocGenerationSampleFndSingleDocxLwcEnglish.html';
import tmpl_nds from './pocAppendPdfdocGenerationSampleFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pocAppendPdfdocGenerationSampleFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
