...
import { OMNIDEF } from './pDF_SimulazioneFndSingleDocxLwcEnglish_def.js';
import tmpl from './pDF_SimulazioneFndSingleDocxLwcEnglish.html';
import tmpl_nds from './pDF_SimulazioneFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pDF_SimulazioneFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
