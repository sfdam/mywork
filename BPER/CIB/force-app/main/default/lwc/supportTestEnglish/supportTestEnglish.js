...
import { OMNIDEF } from './supportTestEnglish_def.js';
import tmpl from './supportTestEnglish.html';
import tmpl_nds from './supportTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class supportTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
