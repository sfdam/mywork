...
export default class CibLineaSimulazione extends LightningElement {
        ...
        try {
            ...
            if((this.fieldToCheck === 'Tipo_di_ammortamento__c' || this.fieldToCheck === 'Formatecnica__c' || this.fieldToCheck === 'Durata__c' || this.fieldToCheck === 'Periodicita_rata__c' || this.fieldToCheck === 'Importo__c')){
                ...
                if(this.lineaSimulazione.Tipo_di_ammortamento__c !== 'ad_hoc'){
                    this.rateLineeToDelete = this.rateLineeToDelete.concat([...this.ammortamentoAdHoc]);
                    this.ammortamentoAdHoc = [];
                    ...
                    if(this.lineaSimulazione.Numerodirate__c){
                        ...
                        for(var i = 1; i < this.ammortamentoAdHoc.length; i++){
                            ...
                            this.ammortamentoAdHoc[i]['PercNonutilizzato__c'] = Number(parseFloat(100 - this.ammortamentoAdHoc[i]['percentualeUtilizzoAmmortamento__c']).toFixed(2));
                            this.ammortamentoAdHoc[i]['Nonutilizzato__c'] = Number(parseFloat((this.ammortamentoAdHoc[i-1]['Nonutilizzato__c'] + this.ammortamentoAdHoc[i-1]['quotaCapitaleResiduaAmmortamento__c'])*(this.ammortamentoAdHoc[i]['PercNonutilizzato__c']/100)).toFixed(2));
                            this.ammortamentoAdHoc[i]['QuotaCapitaleUtilizzato__c'] = Number(parseFloat((this.ammortamentoAdHoc[i-1]['Nonutilizzato__c'] + this.ammortamentoAdHoc[i-1]['quotaCapitaleResiduaAmmortamento__c'])*(this.ammortamentoAdHoc[i]['percentualeUtilizzoAmmortamento__c']/100)).toFixed(2));
                            this.ammortamentoAdHoc[i]['quotaCapitaleResiduaAmmortamento__c'] = Number(parseFloat(this.ammortamentoAdHoc[i]['QuotaCapitaleUtilizzato__c'] - this.ammortamentoAdHoc[i]['QuotaCapAmmortamento__c']).toFixed(2));
                        }
                    }else{
                        this.ammortamentoAdHoc = [];
                    }
                    ...
                    do {
                        this.rateLineeToDelete.push(this.ammortamentoAdHoc.pop());
                ...
                if(this.ammortamentoAdHoc && this.ammortamentoAdHoc.length > 0){
                    for(let i = 0; i < this.ammortamentoAdHoc.length; i++){
                        ...
                        if(this.fieldToCheck === 'Importo__c'){
                            ...
                            this.ammortamentoAdHoc[i]['Nonutilizzato__c'] = i == 0 ? Number(parseFloat(this.lineaSimulazione.Importo__c * (this.ammortamentoAdHoc[i]['PercNonutilizzato__c']/100)).toFixed(2)) : Number(parseFloat((this.ammortamentoAdHoc[i-1]['Nonutilizzato__c'] + this.ammortamentoAdHoc[i-1]['quotaCapitaleResiduaAmmortamento__c'])*(this.ammortamentoAdHoc[i]['PercNonutilizzato__c']/100)).toFixed(2));
                        }
                    }
                }
            }
    ...
    handleCopyValues(event){
        ...
        if(this.ammortamentoAdHoc[index+1]){
            ...
            if(this.ammortamentoAdHoc.length > 0){
                this.ammortamentoAdHoc[0]['PercNonutilizzato__c'] = Number(parseFloat(100 - this.ammortamentoAdHoc[0]['percentualeUtilizzoAmmortamento__c']).toFixed(2));;
                this.ammortamentoAdHoc[0]['Nonutilizzato__c'] = Number(parseFloat(this.lineaSimulazione.Importo__c * (this.ammortamentoAdHoc[0]['PercNonutilizzato__c']/100)).toFixed(2));
                this.ammortamentoAdHoc[0]['QuotaCapitaleUtilizzato__c'] = Number(parseFloat(this.lineaSimulazione.Importo__c - this.ammortamentoAdHoc[0]['Nonutilizzato__c']).toFixed(2));
                this.ammortamentoAdHoc[0]['quotaCapitaleResiduaAmmortamento__c'] = Number(parseFloat(this.ammortamentoAdHoc[0]['QuotaCapitaleUtilizzato__c'] - this.ammortamentoAdHoc[0]['QuotaCapAmmortamento__c']).toFixed(2));
                for(var i = 1; i < this.ammortamentoAdHoc.length; i++){
                    console.log('Dk i-1', i-1);
                    // this.ammortamentoAdHoc[i]['PercNonutilizzato__c'] = this.ammortamentoAdHoc[i-1]['PercNonutilizzato__c'] - this.ammortamentoAdHoc[i]['percentualeUtilizzoAmmortamento__c'];
                    this.ammortamentoAdHoc[i]['PercNonutilizzato__c'] = Number(parseFloat(100 - this.ammortamentoAdHoc[i]['percentualeUtilizzoAmmortamento__c']).toFixed(2));
    ...
    handleFilterRata(event){
        try {
            ...
            event.target.type == 'number' ? Number(parseFloat(event.target.value).toFixed(2)): ['true', 'false'].includes(event.target.value) ? /^true$/i.test(event.target.value) : event.target.value;
            ...
            if(event.target.name.split('#')[0] === 'Erogato__c'){
                ...
                console.log('Dk this[keyList[0]] START', JSON.stringify(this[keyList[0]]));
                let numberSet = this[keyList[0]].map(element => element.number);
                let numberInvalidFieldMap = {};
                this[keyList[0]][index]['PercNonutilizzato__c'] = Number(parseFloat(100 - this[keyList[0]][index]['percentualeUtilizzoAmmortamento__c']).toFixed(2));
                if(index === 0){
                    this[keyList[0]][index]['Nonutilizzato__c'] = Number(parseFloat(this.lineaSimulazione.Importo__c * (this[keyList[0]][index]['PercNonutilizzato__c']/100)).toFixed(2));
                    this[keyList[0]][index]['QuotaCapitaleUtilizzato__c'] = Number(parseFloat(this.lineaSimulazione.Importo__c - this[keyList[0]][index]['Nonutilizzato__c']).toFixed(2))
                    this[keyList[0]][index]['quotaCapitaleResiduaAmmortamento__c'] = Number(parseFloat(this[keyList[0]][index]['QuotaCapitaleUtilizzato__c'] - this[keyList[0]][index]['QuotaCapAmmortamento__c']).toFixed(2));
                ...
                for(var i = 1; i < this[keyList[0]].length; i++){
                    console.log('Dk i-1', i-1);
                    // this[keyList[0]][i]['PercNonutilizzato__c'] = this[keyList[0]][i-1]['PercNonutilizzato__c'] - this[keyList[0]][i]['percentualeUtilizzoAmmortamento__c'];
                    this[keyList[0]][i]['PercNonutilizzato__c'] = Number(parseFloat(100 - this[keyList[0]][i]['percentualeUtilizzoAmmortamento__c']).toFixed(2));
                    this[keyList[0]][i]['Nonutilizzato__c'] = Number(parseFloat((this[keyList[0]][i-1]['Nonutilizzato__c'] + this[keyList[0]][i-1]['quotaCapitaleResiduaAmmortamento__c'])*(this[keyList[0]][i]['PercNonutilizzato__c']/100)).toFixed(2));
                    this[keyList[0]][i]['QuotaCapitaleUtilizzato__c'] = Number(parseFloat((this[keyList[0]][i-1]['Nonutilizzato__c'] + this[keyList[0]][i-1]['quotaCapitaleResiduaAmmortamento__c'])*(this[keyList[0]][i]['percentualeUtilizzoAmmortamento__c']/100)).toFixed(2));
                    this[keyList[0]][i]['quotaCapitaleResiduaAmmortamento__c'] = Number(parseFloat(this[keyList[0]][i]['QuotaCapitaleUtilizzato__c'] - this[keyList[0]][i]['QuotaCapAmmortamento__c']).toFixed(2));
                ...
                console.log('Dk this[keyList[0]] END', JSON.stringify(this[keyList[0]]));
                ...
                numberSet.forEach(number =>{
                    this.template.querySelectorAll("[data-key='"+ number +"']").forEach(inputField =>{
                        console.log('DK numberSet field:', inputField.name);
                        if(inputField.name){
    ...
    returnRecord(){
        try {
            ...
            this.lineaSimulazione.rateLineeToDelete = this.rateLineeToDelete.filter(element =>{return element.Id != undefined});
    ...
    customFieldValidation(){
        ...
        if(this.lineaSimulazione.Tipo_di_ammortamento__c === 'ad_hoc' && this.ammortamentoAdHoc){

            console.log('DK this.ammortamentoAdHoc[this.ammortamentoAdHoc.length-1]', JSON.stringify(this.ammortamentoAdHoc[this.ammortamentoAdHoc.length-1]));
        }
