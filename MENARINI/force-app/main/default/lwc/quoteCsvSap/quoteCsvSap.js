...
import getCsvQuoteLineItems from '@salesforce/apex/QuoteSuggestionsController.getCsvQuoteLineItems';
import {ShowToastEvent} from "lightning/platformShowToastEvent";

export default class QuoteCsvSap extends LightningElement {
    @api recordId;
    csv = "";

    @wire(getCsvQuoteLineItems, {quoteId: '$recordId'}) wiredQuoteLineItems({error, data}) {
        if(data) {
            this.csv = data;
        } else if (error) {
